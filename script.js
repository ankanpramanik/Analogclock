...
function showPosition(position) {
  ...
  console.log(lat, lon);
  $.getJSON('https://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + lon + '&units=metric&appid=af095c1bac8fb6ed8c24c7cf694358ba', function (data) {
    var text1 = `${data['weather'][0]['main']}`
    // u can change these names like --- Weather:------ 



    var text2 = `<img src='https://openweathermap.org/img/wn/${data['weather'][0]['icon']}@2x.png'>`
